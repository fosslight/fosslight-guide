...
- [**FOSSLight Source Scanner**](1_source/README.md)는 소스코드 스캔 작업을 위해 **[scancode-toolkit](https://github.com/nexB/scancode-toolkit)** 오픈 소스를 이용합니다.
- [**FOSSLight Dependency Scanner**](2_dependency/README.md)는 Package manager에 따라 다음 오픈소스를 이용하여 디펜던시 분석을 수행합니다.
...
- [**FOSSLight Source Scanner**](1_source/README.md)
- [**FOSSLight Dependency Scanner**](2_dependency/README.md)
- Release 예정 프로젝트 목록
