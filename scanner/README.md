...
## 필요 조건
{: .left-bar-title} 
1. [**FOSSLight Scanner**](https://github.com/fosslight/fosslight_scanner)는 Python 3.10 이상(공식 지원 버전: 3.10~3.14) 환경에서 동작하며, pip3 명령을 통해 설치할 수 있습니다.    
2. (windows의 경우) [Microsoft Build Tools (Microsoft Visual C++ 14.0+)](https://visualstudio.microsoft.com/ko/visual-cpp-build-tools/)를 설치해야 합니다.
3. [Virtualenv 환경 세팅](https://fosslight.org/fosslight-guide/scanner/etc/guide_virtualenv.html)에 따라 설치 환경을 구축해야 합니다. 
<br><br>
