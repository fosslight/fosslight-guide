...
3. (windows의 경우) Microsoft Build Tools (Microsoft Visual C++ 14.0+) from [https://visualstudio.microsoft.com/en/vs/older-downloads](https://visualstudio.microsoft.com/visual-cpp-build-tools)/를 설치해야 합니다.
