...
**(Windows인 경우)** 실행 파일을 이용한 방법  
    ...
    2. [oss-pkg-info.yaml](https://github.com/fosslight/fosslight_reuse/blob/main/tests/report/oss-pkg-info.yaml) 파일 또는 FOSSLight_OSS-Report*.xlsx가 위치한 Path에 다운로드 받은 파일을 이동  
    3. 파일을 더블 클릭하여 실행  
