...
- **(Windows인 경우)** 실행 파일을 이용한 방법  
  - [FOSSLight Prechecker - Release](https://github.com/fosslight/fosslight_prechecker/releases) 에서 fosslight_prechecker_windows.exe를 다운로드하여 더블클릭하면, 해당 path에서 lint 모드가 실행되고, cmd 실행하여 다른 모드를 실행할 수 있습니다.  
...
<li>
<details markdown="1">
<summary markdown="span">예1) 특정 경로분석 예시</summary>
...
<li>
<details markdown="1">
<summary markdown="span">예2) 특정 파일 분석 예시</summary>
...
<p>yaml 파일 내 경로 작성 시, 특수 문자({, }, [, ], &, *, #, ?, |, -, <, >, =, !, %, @)로 시작하는 경우 쌍따옴표("")를 사용하여 작성해주시기 바랍니다.</p>
